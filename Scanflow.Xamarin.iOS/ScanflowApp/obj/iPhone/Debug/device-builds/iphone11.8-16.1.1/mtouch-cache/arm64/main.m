...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("Scanflow.BarcodeCapture.Xamarin.iOS.dll", &exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "ScanflowApp.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
